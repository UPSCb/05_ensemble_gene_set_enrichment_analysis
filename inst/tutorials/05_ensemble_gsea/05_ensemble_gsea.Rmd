...
tutorial:
  id: "org.bnbio.tutorials.05_ensemble_gene_set_enrichment_analysis"
  version: 0.1
output:
  learnr::tutorial:
    progressive: true
...
txi <- readRDS(here("www/tximport.rds"))

counts <- round(txi$counts)

sample_file <- here("www/samples_table.tsv")
...
res <- readRDS(here("www/G03_vs_G02_at_T04.rds"))
...
```{r report, eval=FALSE, echo=TRUE}
 generateReport(gsa, number = 10, report.dir=here("www/analysis/G03-G02-egsea-report"))
```
